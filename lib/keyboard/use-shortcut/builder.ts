/**
 * ============================================================================
 * CHAINABLE SHORTCUT BUILDER - Runtime Implementation
 * ============================================================================
 *
 * Creates a fluent, chainable API for defining keyboard shortcuts.
...
export function createShortcutBuilder(options: UseShortcutOptions = {}): {
  ...
  const createProxy = (currentState: BuilderState): any => {
...
function debugLog(debug: boolean | undefined, ...args: any[]) {
  if (debug) {
