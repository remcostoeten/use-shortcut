...
`,
        "registry.ts": `import type { HandlerOptions } from "@remcostoeten/use-shortcut/react"
...
`,
        "runtime.ts": `import type { HandlerOptions, ShortcutMap } from "@remcostoeten/use-shortcut/react"
...
This folder was generated from the local use-shortcut scaffold template.
...
\`\`\`bash
The npm package no longer publishes a CLI binary. Use this scaffold output as local template source instead of \`npx @remcostoeten/use-shortcut scaffold\`.
\`\`\`
