...
function getButtonClasses(variant: TButtonVariant = "default", size: TButtonSize = "default") {
...
function getBadgeClasses({ variant = "default", customClass }: TBadgeProps): string {
...
export function CodeBlock({
  ...
  useEffect(() => {
    ...
    function mouseDownHandler(e: MouseEvent) {
      if (e.button !== 0 || !slider) return; // Only left mouse button
      setIsDragging(true);
