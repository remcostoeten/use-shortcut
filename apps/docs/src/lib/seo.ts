...
const DEFAULT_IMAGE = "https://use-shortcut.vercel.app/og-image.svg";
const DEFAULT_TITLE = "use-shortcut docs";
const SITE_URL = "https://use-shortcut.vercel.app";
const SITE_NAME = "use-shortcut docs";
const DEFAULT_IMAGE_ALT = "use-shortcut docs with feature highlights for typed React keyboard shortcuts";
...
export function applySeoMeta({
  ...
  upsertMeta("name", "twitter:creator", "@remcostoeten");
