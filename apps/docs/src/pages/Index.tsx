...
export default function Index() {
  ...
  const upcomingItems = registryItems.filter(
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <div className="relative overflow-x-clip">
        <div
          className="hidden lg:block pointer-events-none select-none absolute inset-0"
          aria-hidden="true"
        >
          <div className="absolute top-[320px] left-0 right-0 h-px bg-border/40" />
          <div
            className="absolute top-[320px] left-0 right-0 h-px border-t border-dashed border-border/30"
            style={{ top: "520px" }}
          />
          <div
            className="absolute left-0 right-0 h-px border-t border-dashed border-border/20"
            style={{ top: "780px" }}
          />
        </div>
        ...
        <main
          id="main-content"
          className="mx-auto max-w-2xl border-x border-border min-h-screen relative z-10"
        >
