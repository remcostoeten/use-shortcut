...
export function RegistryCard({ item }: RegistryCardProps) {
    ...
    <>
      <div className="flex min-w-0 flex-col gap-3">
        <div className="flex min-w-0 items-center gap-2">
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded border border-border/80 bg-card/55 text-primary">
  ...
  const className = cn(
    ...
    isClickable
      ? "will-change-transform hover:border-primary/40 hover:bg-card/20 hover:shadow-[0_10px_30px_-20px_rgba(0,0,0,0.8)] hover:after:opacity-100 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:after:opacity-100"
